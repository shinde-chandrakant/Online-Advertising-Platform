...
class AdServer:
    ...
    def fetchAds(self):
        ...
        conditionStatement = "where status = 'active' and  CURRENT_TIMESTAMP() between TIMESTAMP(dateRangeStart,timeRangeStart) and TIMESTAMP(dateRangeEnd,timeRangeEnd) "
...
if __name__ == "__main__":
    ...
    try:
        ...
        def serve(user_id):
            ...
            if "device_type" not in query_params:
                return abort(400)
            ...
            ad_server_object.state = query_params["state"]
            ad_server_object.city = query_params["city"]
            ad_server_object.device = query_params["device_type"]
