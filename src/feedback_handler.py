...
class FeedbackHandler:
    ...
    def createKafkaTopic(self):
        bootstrap_servers = ['18.211.252.152:9092']
        admin_client = KafkaAdminClient(bootstrap_servers=bootstrap_servers)
        topic_list = []
        topic_list.append(NewTopic(name=self.Kafka_topic, num_partitions=1, replication_factor=1))
        ...
        if self.Kafka_topic in existing_topics:
            ...
            print(f"Topic '{self.Kafka_topic}' created successfully.")
    ...
    def SendDatatoKafkaProducer(self):
        ...
        producer.send(self.Kafka_topic, jsonData.encode('utf-8'))
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Create kafka topic
        feedback_handler.createKafkaTopic()
